...
faq:
  - question: What formats can I convert to?
    answer: MP3 — universal, works everywhere, for music and podcasts. M4A (AAC) — same idea, better quality at the same bitrate, the standard on Apple devices and for audiobooks. M4R — an M4A named for iPhone's ringtone picker. WAV and AIFF — uncompressed, for editing and archiving (WAV is the Windows standard, AIFF is Apple's equivalent). OGG and Opus — open formats (OGG suits games and web audio, Opus gives the best compression at low bitrates, for voice and streaming). FLAC — lossless compression, for archiving music at source quality. WMA — the older Windows Media format, for compatibility with older software.
