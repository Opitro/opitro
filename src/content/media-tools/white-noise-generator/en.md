...
faq:
  ...
  - question: What is white noise?
    answer: A steady hiss with equal energy at every frequency — the sound of an untuned radio or old TV static. That evenness is exactly what lets it cover up other sounds.
  - question: Which noise is best for sleep?
    answer: White masks sharp sounds best, but some people find it too hissy. [Pink](/en/pink-noise-generator) is softer and rain-like; [brown](/en/brown-noise-generator) is the deepest, like a distant waterfall. Play all three and pick by ear — it takes a minute.
  - question: Why download a file if I can just listen?
    answer: To listen offline, on a plane, or in a player on your phone. You don't need a long file for that — download a short one and switch on repeat; the join is inaudible. That's why thirty minutes is the maximum here, since an hour-long file runs to hundreds of megabytes and may simply fail to build on a phone.
