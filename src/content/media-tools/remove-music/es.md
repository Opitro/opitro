...
faq:
  - question: ¿En qué se diferencian los tres métodos?
    answer: "«Navegador» es instantáneo y no descarga nada: extrae el centro de la imagen estéreo, donde suele estar la voz. «Red neuronal» separa de verdad voz y música — el modelo se descarga una vez, 38 MB, y se queda en el navegador. «Red neuronal Pro» hace lo mismo con más limpieza, pero es pesada y funciona en ordenador."
  - question: ¿Qué es el control de fuerza?
    answer: Pertenece solo al «Navegador» y decide cuánto restar. A plena fuerza la música se va junto con parte de la voz; más abajo la voz queda intacta pero el fondo se oye más. Las redes neuronales no tienen nada que ajustar, así que allí el control se oculta.
  ...
  - question: ¿Por qué «Red neuronal Pro» no arranca en el móvil?
    answer: "Está pensada para ordenador: en un móvil ese cálculo llevaría horas y casi con seguridad se cortaría. El botón sigue visible, lo dice claramente y te lleva a «Red neuronal», que funciona en todas partes."
...
Sube una canción y elige un método. El resultado suena enseguida, y pulsar el mismo método otra vez devuelve el original.
...
- **Red neuronal Pro** — el mejor resultado posible. Funciona solo en ordenador.

## Conviene saber

Todo se calcula en tu dispositivo: ni la canción ni el resultado se envían a ningún sitio. Descarga en WAV, MP3 u OGG. ¿Necesitas la pista instrumental? El botón [quitar la voz](/es/vocal-remover) está junto a la descarga y tu archivo viaja allí contigo.
