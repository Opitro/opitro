...
faq:
  ...
  - question: Only one channel works — is it the speaker or the file?
    answer: Check here first. If both sides play on this page but your recording comes out of one side, the recording is the problem — it is mono or has a broken channel. [Convert it to stereo](/en/mono-to-stereo) and it will play in both.
  - question: Do I need to install anything?
    answer: No. The sound is generated inside your browser — nothing is downloaded and nothing is sent anywhere. Works on phones, tablets and computers.
  - question: Why do both sides sound the same on my phone?
...
- **Whether the headphones are on the right way round** — if "Left" comes from the right, you have them backwards
- **Whether both channels work** — silence on one side means a break in the cable, the jack or the driver
- **Whether wired speakers are swapped** at the back
- **Where the sound is actually going** — after HDMI, Bluetooth or a dock, the system often switches output on its own

If both sides play evenly here but your music only comes from the left, the problem is in the file, not the hardware.
