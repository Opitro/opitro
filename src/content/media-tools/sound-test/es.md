...
faq:
  ...
  - question: Solo suena un canal — ¿es el altavoz o el archivo?
    answer: Compruébalo aquí. Si en esta página suenan los dos lados y tu grabación sale por uno solo, el problema es la grabación — es mono o tiene un canal dañado. [Conviértela a estéreo](/es/mono-to-stereo) y sonará por los dos.
  - question: ¿Hay que instalar algo?
    answer: "No. El sonido se genera en tu navegador: no se descarga nada ni se envía nada a ningún sitio. Funciona en móvil, tableta y ordenador."
  - question: ¿Por qué en el móvil los dos lados suenan igual?
...
- **Si llevas los auriculares en el lado correcto** — si «Izquierdo» suena a la derecha, los tienes al revés
- **Si funcionan los dos canales** — el silencio en un lado indica un corte en el cable, el conector o el altavoz
- **Si los altavoces con cable están cambiados** de sitio
- **Adónde va realmente el sonido** — tras HDMI, Bluetooth o una base, el sistema suele cambiar la salida por su cuenta

Si aquí suenan los dos lados por igual pero tu música solo sale por la izquierda, el problema está en el archivo, no en el equipo.
