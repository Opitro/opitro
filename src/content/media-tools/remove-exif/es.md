...
faq:
  ...
  - question: "¿Qué formatos admite?"
    answer: "JPEG, PNG y WebP, que son los que llevan campos. En JPEG se van los bloques EXIF, XMP e IPTC; en PNG, los trozos de servicio con campos y textos; en WebP, los trozos EXIF y XMP. El perfil de color no se toca: sin él los colores se desviarían, y no contiene nada sobre la persona."
  - question: "¿Y una foto de iPhone?"
    answer: "Por defecto el iPhone guarda las fotos en HEIC y el navegador no sabe desmontar esos archivos: es un límite del navegador. Vuelva a tomarla en JPEG: Ajustes → Cámara → Formatos → «Más compatible»."
