...
engineParams:
  ...
  fromUnitShort: st
  toUnitShort: kg
title: Conversor de stone a kg online, gratis, sin registro
h1: Stone a Kilogramos
summary: "1 stone = 6,35 kg; 11 stone = 70 kg"
...
Si te encontraste con un peso en stone — en una web del Reino Unido, un artículo de boxeo, o simplemente en una conversación — esto lo convierte a los kilogramos de siempre.

Los pesos en stone a menudo se dan con un resto — "12 stone 4" significa 12 stone más 4 libras — si ese es tu número, convierte primero las libras a stone (4 lb ≈ 0.286 stone) y súmalo antes de convertir.
