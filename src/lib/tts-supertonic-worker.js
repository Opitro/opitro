...
//
// ПОТОК ПРОГНАН как настоящий Web Worker: задание по договору -> готовый файл 192 КБ за
// 16,8 с на чистом профиле (включая 380 МБ модели). Пик в самом WAV 0,459. Шкала по
// байтам прошла ровно от нуля до ста, кэш отработал -- второй заход без скачивания.
//
