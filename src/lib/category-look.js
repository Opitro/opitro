...
const ЗНАЧКИ = {
  // Рамка снимка с солнцем и горами -- как значок фотографии в любом телефоне.
  ...
  // Рамка видоискателя с чертой посередине -- знак, который читается раньше слова: так
  // выглядит наводка камеры на код в любом приложении.
...
const ВИД = {
  ...
  // Фигурные скобки -- знак, который разработчик читает раньше слова. Цвет фуксия: из
  // свободных он дальше всего и от фиолетового «Объёма», и от розовой «Температуры»;
  // две рубрики одного цвета взгляд не различает.
  dev: { значок: 'braces', цвет: '#e879f9' },
  // Васильковый: из свободных оттенков он дальше всего и от голубой «Длины», и от
  // фиолетового «Объёма» -- две рубрики одного цвета взгляд не различает.
